        ...
        <div class="col-xs-12">
            <form class="form-horizontal" autocomplete="off" id="validation-form" novalidate="novalidate" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="username" id="username" aria-required="true" aria-invalid="true" placeholder="手机号" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                </div>
    ...
    jQuery(function($) {
        $('#validation-form').validate({
            ...
            submitHandler: function (form) {
                ...
                g.func.ajaxPost("/admin/user/add", param , function(res){
