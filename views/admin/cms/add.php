        ...
        <div class="col-xs-12">
            <form class="form-horizontal" autocomplete="off" id="validation-form" novalidate="novalidate" method="post" action="/admin/cms/add" >
                            ...
                            <select name="cate_id" id="cate_id" aria-required="true" aria-invalid="true">
                                ...
                                {foreach $cate as $cli}
                                    <?php foreach($cate as $cli_next) { ?>
                                        <option value="<?php echo $cli_next['id']; ?>">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $cli_next['cate_name']; ?></option>
                                    <?php } ?>
                                {/foreach}
                                {/if}
                            </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="title" aria-required="true" aria-invalid="true" placeholder="标题" class="col-xs-10 col-sm-5 title" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="description" aria-required="true" aria-invalid="true" placeholder="文章简介" class="col-xs-10 col-sm-5 description" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="clearfix">
                            ...
                            <input type="hidden" name="image" id="image" placeholder="封面图" class="col-xs-10 col-sm-5" />
                            <div class="row ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="clearfix">
                            <input type="text"  name="view" value="0" aria-required="true" aria-invalid="true"  placeholder="查看次数" class="col-xs-10 col-sm-5 view" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="clearfix">
                            <input type="text"  name="likes" value="0" aria-required="true" aria-invalid="true"  placeholder="点赞次数" class="col-xs-10 col-sm-5 likes" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="sort" aria-required="true" aria-invalid="true"  placeholder="排序,请输入数字,数字越小越消息靠前." class="col-xs-10 col-sm-5 sort" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="radio">
                            <label>
                                <input name="home_top" value="2" checked="checked"  type="radio" class="ace home_top" />
                                <span class="lbl"> 否</span>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input name="home_top" value="1" type="radio" class="ace home_top" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="radio">
                            <label>
                                <input name="list_top" value="2" checked="checked"  type="radio" class="ace list_top" />
                                <span class="lbl"> 否</span>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input name="list_top" value="1" type="radio" class="ace list_top" />
                                <span class="lbl"> 是</span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="radio">
                            <label>
                                <input name="state" value="2" type="radio" class="ace state" />
    ...
    jQuery(function($) {
        $('#validation-form').validate({
            ...
            submitHandler: function (form) {
                ...
                g.func.ajaxPost("/admin/cms/add", param , function(res){
