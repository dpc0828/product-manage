        ...
        <div class="col-xs-12">
            <form class="form-horizontal" autocomplete="off" id="validation-form" novalidate="novalidate" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="cate_name" id="cate_name" aria-required="true" aria-invalid="true" placeholder="登录用户名" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="clearfix">
                            ...
                            <input type="hidden" name="image" id="image" aria-required="true" aria-invalid="true"  placeholder="分类图标" class="col-xs-10 col-sm-5" />
                            <div class="row ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="clearfix">
                            <input type="text" id="sort" name="sort" placeholder="数字越小展示越靠前" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                </div>
    ...
    jQuery(function($) {
        $('#validation-form').validate({
            ...
            submitHandler: function (form) {
                ...
                g.func.ajaxPost("/admin/cms/add-cate", param , function(res){
