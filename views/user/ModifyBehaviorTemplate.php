...
<div class="col-xs-offset-3 col-md-offset-0 col-sm-offset-0 col-lg-offset-0">
    ...
    <div class="padding-2">
        <blockquote class="layui-elem-quote layui-quote-nm suspend_shadow">
            ...
            <p>
                <strong>2、修改模板后，需重新应用到对应商品（商品的购买行为不会随着模板的修改而改变）</strong>
            </p>
        </blockquote>
        <br />
        <form class="layui-form narrow_2" id="behavior" action="javascript:;" lay-filter="behavior">
            ...
            <div class=" text-center">
                <?php if(!empty($info)) { ?>
                <button class="layui-btn" onclick="saveModifyTemplate(<?php echo $info['id']; ?>, '<?php echo $info['template_name']; ?>', 1)">保存模板</button>
                <?php } ?>
            </div>
        </form>
    </div>
