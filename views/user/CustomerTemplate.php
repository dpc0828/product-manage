...
<div class="col-xs-offset-3 col-md-offset-0 col-sm-offset-0 col-lg-offset-0">
    ...
    <div class="padding-2">
        <table class="layui-table" lay-skin="line">
                            ...
                            <td>
                                <div class="layui-btn-group">
                                    <button
                                        ...
                                        onclick="handleTemplate.previewTemplate(<?php echo $li['id']; ?>, 0, '<?php echo $li['template_name']; ?>')"
                                    >预览</button>
                                    <button
                                        type="button"
                                        class="layui-btn layui-btn-sm"
                                        onclick="handleTemplate.useTemplate(<?php echo $li['id']; ?>, 0)"
                                    >应用</button>
                                    <button
                                        type="button"
                                        class="layui-btn layui-btn-sm"
                                        onclick="handleTemplate.modifyTemplate(<?php echo $li['id']; ?>, 0, '<?php echo $li['template_name']; ?>')"
                                    >修改</button>
                                    <button
                                        type="button"
                                        class="layui-btn layui-btn-sm"
                                        onclick="handleTemplate.delTemplate(<?php echo $li['id']; ?>, 0)"
                                    >删除</button>
                                </div>
                            </td>
                        </tr>
            ...
            <tfoot>
            <strong>
                <a href="javascript:;" onclick="handleTemplate.addTemplate(0)">
                    【 点击新增 】
                </a>
            </strong>
            <tfoot>
